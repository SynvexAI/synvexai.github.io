...
export default function Roadmap() {
  const steps = [
      ...
      },
    {
      ...
      items: [
        "Обучение модели Mind 5",
        "Разработка Devex — совокупность процессов, инструментов и стандартов, которые делают работу разработчиков быстрее, удобнее и предсказуемее.",
        "Поиск вычислительных ресурсов, чтобы ускорить обучение моделей и повысить их эффективность."
      ]
    }
  ];
